      ...
      <div className="container mx-auto max-w-[1164px] flex justify-between">
        <div className="flex justify-between flex-wrap p-6 pb-0">
          <div className="flex items-center flex-shrink-0 text-white mr-[50px] pb-[25px]">
            <img src="face.png" className="w-100 h-10 mr-2" alt="Logo" />
            <h2 className="text-base font-bold leading-6 text-black" style={{fontSize:'1rem', fontWeight:'700', marginBottom:'0px'}}>
          ...
          >
            <div className="text-sm lg:flex-grow lg:space-x-[50px] space-x-0">
              <a
                href="/"
                className="block lg:inline-block lg:mt-0 text-white-200 mr-4 text-sm text-[#4338ca] pb-0 lg:pb-[25px] lg:border-b lg:border-[#4338ca] "
              >
                Detection center
              </a>
              <a
                href="/"
                className="block lg:inline-block lg:mt-0 text-white-200 mr-4 text-sm hover:text-[#4338ca]"
              >
                Privacy Policy
              </a>
              <a
